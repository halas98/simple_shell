...
/**
 * help_all - Shows a list of all available shellby built-in commands.
 */
...
/**
 * help_alias - Provides details about the 'alias' built-in command in shellby.
 */
...
/**
 * help_cd - Provides details about the 'cd' built-in command in shellby.
 */
...
/**
 * help_exit - Provides details about the 'exit' built-in command in shellby.
 */
...
/**
 * help_help - Provides details about the 'help' built-in command in shellby.
 */
